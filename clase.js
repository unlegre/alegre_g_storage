...
boton_simulador.addEventListener("click",function(){
 ...
 for  ( let i= 0; i < 1 ; i++){
    ...
    let monto_1 = parseInt(prompt("Simulador de Prestamo----Ingrese Monto a Solicitar"))
...
localStorage.setItem("diez_mil","cuotas_3"); //guardo datos con setItem
localStorage.setItem("diez_mil","cuotas_6"); 
localStorage.setItem("diez_mil","cuotas_12"); 
localStorage.setItem("diez_mil","cuotas_18"); 

// monto y cuotas

let diez_mil =document.getElementById("diez_mil");

diez_mil.addEventListener("click",function(){
    alert("10 mil !!!");
    }
    ) 

    
let cincuenta_mil =document.getElementById("cincuenta_mil");

cincuenta_mil.addEventListener("click",function(){
    alert("50 mil !!!");
    }
    ) 

    
let cien_mil =document.getElementById("cien_mil");

cien_mil.addEventListener("click",function(){
    alert("100 mil !!!");
    }
    ) 
